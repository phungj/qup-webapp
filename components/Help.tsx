...
export default function Help() {
    return (
        <div className="text-center flex flex-col items-center">
            ...
            <h2 className="text-2xl mb-10">Skill grids are loaded using the following JSON specification and coordinate system.</h2>
    ...
    "skills": [
        {
            ...
            <Image src={grid}
                   ...
                   height={500}
                   className="mb-5"/>
            <h2 className="text-2xl mb-10">Each grid may only have one skill at each hex and one copy of each skill.</h2>
